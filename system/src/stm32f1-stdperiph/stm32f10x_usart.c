...
void USART_Init(USART_TypeDef* USARTx, USART_InitTypeDef* USART_InitStruct)
{
	...
	assert_param(
			IS_USART_HARDWARE_FLOW_CONTROL(USART_InitStruct->USART_HardwareFlowControl));
...
/**
 * @brief  Enables or disables the USART锟絪 DMA interface.
 * @param  USARTx: Select the USART or the UART peripheral. 
 *   This parameter can be one of the following values:
 *   USART1, USART2, USART3, UART4 or UART5.
...
/**
 * @brief  Enables or disables the USART锟絪 LIN mode.
 * @param  USARTx: Select the USART or the UART peripheral. 
 *   This parameter can be one of the following values:
 *   USART1, USART2, USART3, UART4 or UART5.
...
/**
 * @brief  Enables or disables the USART锟絪 Smart Card mode.
 * @param  USARTx: where x can be 1, 2 or 3 to select the USART peripheral.
...
/**
 * @brief  Enables or disables the USART锟絪 Half Duplex communication.
 * @param  USARTx: Select the USART or the UART peripheral. 
 *   This parameter can be one of the following values:
 *   USART1, USART2, USART3, UART4 or UART5.
